...
using TelegramBot.DB;
using TelegramBot.GetArtistInfo;
...
namespace TelegramBot
{
    class Program
    {
        ...
        private const string stpath = @"C:\Users\Irina\Desktop\DBst.json";
            ...
            switch (st.statuses[index].status2)
            {
                ...
                case 1:
                    { //addfavorite
                        ...
                        var response = await client.PostAsync($"https://localhost:44348/api/Music/AddFavorite", data);
                ...
                case 2:
                    {
                        ...
                        HttpClient client = new HttpClient();
                        var response = await client.PutAsync($"https://localhost:44348/api/Music/DeleteFavorite", data);
                        string result = response.Content.ReadAsStringAsync().Result;
